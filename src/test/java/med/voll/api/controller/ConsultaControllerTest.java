...
class ConsultaControllerTest {
    ...
    private AgendaDeConsultaService agendaDeConsultaService;
        ...
        void agendarEscenario2 () throws Exception {
            ...
            var datos = new DatosDetalleConsulta((Long) null, 21L, 51L,fecha);


            // when

            when(agendaDeConsultaService.agendar(any())).thenReturn(new DatosDetalleConsulta((Long) null, 21L, 51L,fecha));
